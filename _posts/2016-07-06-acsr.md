...
{% highlight text %}
## Error in library(acsr): there is no package called 'acsr'
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): could not find function "sumacs"
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): could not find function "acsdata"
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): could not find function "combine.output"
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): object 'pov' not found
{% endhighlight %}
