...
rm(list=ls(all=TRUE))
pathcode <- "/Users/sdaza/Documents/UWSociology/00Projects/Meier/prog/"
pathdata <- "/Users/sdaza/Documents/UWSociology/00Projects/Meier/usrdata/"
...
library(tables)
library(VIM)
load(paste0(pathdata, "addhealth_work01.Rd"))

dats <- dat[rape1 == 0 & rape2 == 0
& gswgt2 > 0 & gswgt1 > 0, ] # no raped people
...
nvars <- c("female", "age", "race", "class", "publicass", "bmi", "gpa1", "gpa2", "gpa1.p", "gpa2.p", "dep1.p", "dep1", "dep2.p", "dep2", "ppvt")

dats <- dats[, nvars, with = FALSE]
factors(dats, c("female", "race", "class", "publicass"))
```
