...
The `acsr` package can be used to extract variables and compute statistics from the America Community Survey in a *systematic way*. It was created for the [Applied Population Laboratory](http://www.apl.wisc.edu/) (APT) at the University of Wisconsin-Madison.
