---
layout: post
title: "R package to compute statistics from the American Community Survey (ACS)"
description: ""
category: "R"
tags: [ACS, R]
---
...
The `acsr` package helps extracting variables and computing statistics using the America Community Survey. It was created for the [Applied Population Laboratory](http://www.apl.wisc.edu/) (APT) at the University of Wisconsin-Madison.
...
To download the data can be slow, especially when many levels are being used (e.g., blockgroup). A better approach in those cases is to download the data first using the function `acsdata`, and then use them as input.
