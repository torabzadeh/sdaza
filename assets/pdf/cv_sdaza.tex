...
% \item Palloni, Alberto, Hiram Beltrán-Sánchez and Sebastian Daza (2021). {\textit{Uncertainty and Mortality Estimates in the Latin American and Caribbean (LAC) Region.}}
...
% \item Palloni, Alberto and Sebastian Daza (2018).
%    \textit{Income Inequality, Social Mobility and Mortality in the US.}
