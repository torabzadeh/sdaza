...
\begin{itemize}
\item Social Demography, Social Complexity, Social Network Analysis, Deviance and Crime, Surveys and Methods.
\end{itemize}
...
Under review at \textit{Demography}.

\item Daza, Sebastian, Eric Grodsky and Ann Meier. {\textit{Exploring the Consequences of Adolescent Sex in Behavioral Context.}}.
...
\item \textit{Agent-based Modeling}: NetLogo.
\item \textit{Programming}: Python (basic), \LaTeX{}.
