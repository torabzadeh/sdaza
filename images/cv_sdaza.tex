...
\begin{minipage}[t]{0.3\textwidth}
  ...
  \href{http://sdaza.com/}{http://sdaza.com} \\
...
\item Daza, Sebastian and Kurt Kreuger. {\textit{Agent-Based Models for Assessing Complex Statistical Models: An Example Evaluating Selection and Social Influence Estimates from the SIENA model}}. Sociological Methods and Research. 2019. Forthcoming.
...
\item Daza, Sebastian and Alberto Palloni. {\textit{Income Inequality, Income Mobility, and Mortality in the U.S.}}

\item Daza, Sebastian, Jerrett Jones and Alberto Palloni. {\textit{The Consequences of Incarceration for Mortality for the US}}. Under review.
...
% \item Fletcher, Jason and Sebastian Daza. {\textit{Selection and Influence of Adolescent Violence.}}
\end{itemize}
...
\item \textit{Data Science}: Machine Learning, Deep Learning, NLP, Model Ensemble, Spark, Dash, Shiny.
